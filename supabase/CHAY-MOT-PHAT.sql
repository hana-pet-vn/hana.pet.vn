-- CHẠY MỘT PHÁT: gộp bước 01 → 12. Dán cả file, bấm Run.
-- Xong thì:
--  (1) đọc bảng kết quả cuối: phải ra 5 công tắc · 21 policy · 1 trigger
--  (2) mở web ẨN DANH: xem sản phẩm + đặt 1 đơn CÓ MÃ GIẢM GIÁ + đăng ký nhận tin
--  (3) đăng xuất / đăng nhập lại trang ADMIN để nhận vai chủ shop
-- Hỏng gì → dán file 99-CUU-HOA là về như cũ.
