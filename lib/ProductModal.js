...
/* v20.4: đồng bộ khung ảnh VUÔNG toàn hệ (trang chủ/chi tiết/popup) */
.pm-hero{aspect-ratio:1;display:grid;place-items:center;border-radius:14px;overflow:hidden}
